...
The following KPIs must be calculated:  
...
- 🍽️ **Average Pizzas Per Order** – Qty ÷ Orders  

---

# 📊 Visualization Requirements (Charts)
...
### ⭐ **6. Top 5 Best Sellers (Revenue / Qty / Orders)**  
### ⚠️ **7. Bottom 5 Worst Sellers (Revenue / Qty / Orders)**  

---

# 🖥️ 📊 DASHBOARDS

Below are the two dashboards created for this project:

---

# 🟣 **1. POWER BI DASHBOARD**

This dashboard provides a modern, interactive view of pizza sales performance.  
...
Two dashboards were built using Excel:  
✔ Light Theme  
✔ Dark Theme  

These dashboards include pivot charts, KPI cards, donut charts, hour/day trends, and top/bottom seller analysis.

---

## 🌞 **Excel Dashboard – Light Theme**

<p align="center">
  <img src="https://github.com/your-username/your-repo/blob/main/assets/Pizza%20Sales.png" width="900">
</p>
...
# 🚀 Key Insights
- **Friday/Saturday** = highest sales  
- **12–1 PM & 5–8 PM** = peak hours  
- **Classic pizzas** generate most revenue  
- **Large size** pizzas dominate sales  
- **Classic Deluxe & Chicken Pizza** = top sellers  
- **Brie Care Pizza** = lowest performer  

---

# 📥 How to Use This Project
1. Download the dataset  
2. Open Excel dashboards or Power BI file  
3. Explore KPI cards, slicers & dynamic charts  
